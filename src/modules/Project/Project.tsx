  ...
  return (
    <div className={styles.project}>
      ...
      {features && features.length > 0 && (
        <div className={styles.block}>
          <p className={styles.blockTitle}>{t("projects:project.features")}</p>
      ...
      {project.testData && (
        <div className={styles.testData}>
          <p className={styles.blockTitle}>{t("projects:project.testData")}</p>
          <p className={styles.blockText}>{project.testData}</p>
        </div>
      )}

      <div className={styles.buttons}>
        <ButtonLinks href={project.link} text="Live Demo" target="_blank" />
        <ButtonLinks
          href={project.gitHub}
